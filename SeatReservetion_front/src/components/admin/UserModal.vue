/**
 * UserModal - модальное окно для добавления и редактирования пользователей в админ-панели.
 */
 <template>
      ...
      <form @submit.prevent="handleSubmit" class="modal-body">
        ...
        <div class="form-group">
          ...
          <input
            ...
            :required="!isEdit"
            :placeholder="isEdit ? 'Оставьте пустым, чтобы не менять' : 'Введите пароль (минимум 6 символов)'"
        ...
        <div class="form-group">
          ...
          <select
            id="status_id"
            v-model.number="formData.status_id"
          >
...
const handleSubmit = async () => {
  ...
  try {
    ...
    if (isEdit.value && !dataToSave.password) {
